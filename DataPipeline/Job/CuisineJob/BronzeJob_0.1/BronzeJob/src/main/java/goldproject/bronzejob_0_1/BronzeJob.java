...
package goldproject.bronzejob_0_1;
...
/**
 * Job: BronzeJob Purpose: CSV -> Bronze<br>
 * Description: CSV -> Bronze <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class BronzeJob implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "BronzeJob";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BronzeJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_GOLDPROJECT_BronzeJob = new byte[0];
    static byte[] commonByteArray_GOLDPROJECT_BronzeJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GOLDPROJECT_BronzeJob.length) {
				if(length < 1024 && commonByteArray_GOLDPROJECT_BronzeJob.length == 0) {
   					commonByteArray_GOLDPROJECT_BronzeJob = new byte[1024];
				} else {
   					commonByteArray_GOLDPROJECT_BronzeJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GOLDPROJECT_BronzeJob, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_BronzeJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_GOLDPROJECT_BronzeJob, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_BronzeJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GOLDPROJECT_BronzeJob) {

        	try {

        		int length = 0;
		
						this.RestaurantID = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.RestaurantID,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("RestaurantID="+String.valueOf(RestaurantID));
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.RestaurantID, other.RestaurantID);
						if(returnValue != 0) {
							return returnValue;
						}
...
final String applicationName_tMongoDBOutput_1 = "Talend";
	...
	final String decryptedPassword_tMongoDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:XLfD0h5+q+bktr6Xcx+8rvgbis3SDhtR/H/FO/WEgUzLxUT3/fLk");
        ...
        db_tMongoDBOutput_1.getCollection("bronze_recipes").drop();
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection("bronze_recipes");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */"/home/ZHLoic/dataset/restaurant-menus.csv"/** End field tFileInputDelimited_2:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.RestaurantID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"RestaurantID", "row1", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.category = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.ProductPrice = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
try{
				updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());
                                        ...
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("RestaurantID"),"RestaurantID", row1.RestaurantID);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("category"),"category", row1.category);
                                        ...
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("ProductPrice"),"ProductPrice", row1.ProductPrice);
 ...
 */
    ...
    public static void main(String[] args){
        final BronzeJob BronzeJobClass = new BronzeJob();

        int exitCode = BronzeJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BronzeJob.class.getClassLoader().getResourceAsStream("goldproject/bronzejob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BronzeJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BronzeJob");
        }
...
/************************************************************************************************
 *     56470 characters generated by Talend Open Studio for Big Data 
 *     on the 23 février 2026, 16:36:16 CET
 ************************************************************************************************/