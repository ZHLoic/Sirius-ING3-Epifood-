...
package goldproject.silverjob_0_1;
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(USD_TO_EUR != null){
					...
					this.setProperty("USD_TO_EUR", USD_TO_EUR.toString());
...
public static class silveroutStruct implements routines.system.IPersistableRow<silveroutStruct> {
    final static byte[] commonByteArrayLock_GOLDPROJECT_SilverJob = new byte[0];
    static byte[] commonByteArray_GOLDPROJECT_SilverJob = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final silveroutStruct other = (silveroutStruct) obj;
	...
	public void copyDataTo(silveroutStruct other) {
	...
	public void copyKeysDataTo(silveroutStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GOLDPROJECT_SilverJob.length) {
				if(length < 1024 && commonByteArray_GOLDPROJECT_SilverJob.length == 0) {
   					commonByteArray_GOLDPROJECT_SilverJob = new byte[1024];
				} else {
   					commonByteArray_GOLDPROJECT_SilverJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GOLDPROJECT_SilverJob, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_SilverJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_GOLDPROJECT_SilverJob, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_SilverJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GOLDPROJECT_SilverJob) {
		...
		synchronized(commonByteArrayLock_GOLDPROJECT_SilverJob) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Restaurantid = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Restaurantid,dos);
...
final String applicationName_tMongoDBOutput_1 = "Talend";
    ...
    int nb_line_tMongoDBOutput_1 = 0;
            ...
            java.util.Map<String, String> pathMap_tMongoDBOutput_1=new java.util.HashMap<>();
                ...
                pathMap_tMongoDBOutput_1.put("order_id","");
                pathMap_tMongoDBOutput_1.put("category","");
                pathMap_tMongoDBOutput_1.put("name","");
                pathMap_tMongoDBOutput_1.put("description","");
                pathMap_tMongoDBOutput_1.put("price","");
                pathMap_tMongoDBOutput_1.put("start_order_time","");
                pathMap_tMongoDBOutput_1.put("prep_time","");
                pathMap_tMongoDBOutput_1.put("end_time_prep","");
	...
	final String decryptedPassword_tMongoDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:zKEpx1V6V3JVZxEWxGqViWbIfrFl84WEdFZGL1cbNoq6MQ96Sypu");
                        
	                        mongoCredential_tMongoDBOutput_1 = com.mongodb.MongoCredential.createScramSha256Credential("userjob", "recipes", new String(decryptedPassword_tMongoDBOutput_1).toCharArray());
	                        
                    clientSettingsBuilder_tMongoDBOutput_1.credential(mongoCredential_tMongoDBOutput_1);
                    addrs_tMongoDBOutput_1.add(new com.mongodb.ServerAddress("172.31.252.148", 27017));
        ...
        db_tMongoDBOutput_1.getCollection("silver_recipes").drop();
...
final String applicationName_tMongoDBInput_1 = "Talend";
	...
	final String decryptedPassword_tMongoDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4ke6KXdKnsju3kGuIoYJr5FnOeb+7gq3QYVxE9O9T4oXFCdJGqzW");
        ...
        db_tMongoDBInput_1 = mongo_tMongoDBInput_1.getDatabase("recipes");
				...
				Object valueObj_tMongoDBInput_1=null;
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("Restaurantid"),"Restaurantid",o_tMongoDBInput_1);
					
				row1.Restaurantid = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				...
				row1.description = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
                    ...
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("ProductPrice"),"ProductPrice",o_tMongoDBInput_1);
					
				row1.ProductPrice = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
...
silverout_tmp.order_id = Numeric.sequence("menu_seq", 1, 1);
silverout_tmp.category = row1.category ;
silverout_tmp.name = row1.name ;
silverout_tmp.description = (row1.description == null || row1.description.trim().isEmpty()) ? null : row1.description;
silverout_tmp.price = Math.round(Double.parseDouble(row1.ProductPrice.replace(" USD","")) * context.USD_TO_EUR * 100) / 100.0;
silverout_tmp.start_order_time = null;
silverout_tmp.prep_time = null;
silverout_tmp.end_time_prep = null;
...
try{
				updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());
                                        ...
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("order_id"),"order_id", silverout.order_id);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("category"),"category", silverout.category);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("name"),"name", silverout.name);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("description"),"description", silverout.description);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("price"),"price", silverout.price);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("start_order_time"),"start_order_time", silverout.start_order_time);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("prep_time"),"prep_time", silverout.prep_time);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("end_time_prep"),"end_time_prep", silverout.end_time_prep);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SilverJob.class.getClassLoader().getResourceAsStream("goldproject/silverjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("USD_TO_EUR", "id_Double");
                        if(context.getStringValue("USD_TO_EUR") == null) {
                            context.USD_TO_EUR = null;
                        } else {
                            try{
                                context.USD_TO_EUR=routines.system.ParserUtils.parseTo_Double (context.getProperty("USD_TO_EUR"));
                            } catch(NumberFormatException e){
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "USD_TO_EUR", e.getMessage()));
                                context.USD_TO_EUR=null;
                            }
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("USD_TO_EUR")) {
                context.USD_TO_EUR = (Double) parentContextMap.get("USD_TO_EUR");
            }
        }
...
/************************************************************************************************
 *     68553 characters generated by Talend Open Studio for Big Data 
 *     on the 23 février 2026, 18:21:22 CET
 ************************************************************************************************/