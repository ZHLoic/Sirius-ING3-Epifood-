...
package goldproject.bronzejob_stockage_0_1;
...
/**
 * Job: BronzeJob_Stockage Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class BronzeJob_Stockage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "BronzeJob_Stockage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				BronzeJob_Stockage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BronzeJob_Stockage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_GOLDPROJECT_BronzeJob_Stockage = new byte[0];
    static byte[] commonByteArray_GOLDPROJECT_BronzeJob_Stockage = new byte[0];
			    ...
			    public String AreaCodeM49;

				public String getAreaCodeM49 () {
					return this.AreaCodeM49;
				}
			    ...
			    public String ItemCodeCPC;

				public String getItemCodeCPC () {
					return this.ItemCodeCPC;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GOLDPROJECT_BronzeJob_Stockage.length) {
				if(length < 1024 && commonByteArray_GOLDPROJECT_BronzeJob_Stockage.length == 0) {
   					commonByteArray_GOLDPROJECT_BronzeJob_Stockage = new byte[1024];
				} else {
   					commonByteArray_GOLDPROJECT_BronzeJob_Stockage = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GOLDPROJECT_BronzeJob_Stockage, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_BronzeJob_Stockage, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_GOLDPROJECT_BronzeJob_Stockage, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_BronzeJob_Stockage, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GOLDPROJECT_BronzeJob_Stockage) {

        	try {

        		int length = 0;
		
					this.AreaCode = readString(dis);
					
					this.AreaCodeM49 = readString(dis);
					
					this.Area = readString(dis);
					
					this.ItemCode = readString(dis);
					
					this.ItemCodeCPC = readString(dis);
					
					this.Item = readString(dis);
					
					this.ElementCode = readString(dis);
					
					this.Element = readString(dis);
					
					this.YearCode = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.AreaCode,dos);
					
					// String
				
						writeString(this.AreaCodeM49,dos);
					...
					// String
						...
						writeString(this.ItemCodeCPC,dos);
					...
					// String
						...
						writeString(this.ElementCode,dos);
    ...
    public String toString() {
		...
		sb.append(",AreaCodeM49="+AreaCodeM49);
		sb.append(",Area="+Area);
		sb.append(",ItemCode="+ItemCode);
		sb.append(",ItemCodeCPC="+ItemCodeCPC);
		sb.append(",Item="+Item);
		sb.append(",ElementCode="+ElementCode);
		sb.append(",Element="+Element);
		sb.append(",YearCode="+YearCode);
		sb.append(",Year="+Year);
		sb.append(",Unit="+Unit);
...
final String applicationName_tMongoDBOutput_1 = "Talend";
    ...
    int nb_line_tMongoDBOutput_1 = 0;
            ...
            java.util.Map<String, String> pathMap_tMongoDBOutput_1=new java.util.HashMap<>();
                ...
                pathMap_tMongoDBOutput_1.put("AreaCode","");
                pathMap_tMongoDBOutput_1.put("AreaCodeM49","");
                pathMap_tMongoDBOutput_1.put("Area","");
                pathMap_tMongoDBOutput_1.put("ItemCode","");
                pathMap_tMongoDBOutput_1.put("ItemCodeCPC","");
                pathMap_tMongoDBOutput_1.put("Item","");
                pathMap_tMongoDBOutput_1.put("ElementCode","");
                pathMap_tMongoDBOutput_1.put("Element","");
                pathMap_tMongoDBOutput_1.put("YearCode","");
                pathMap_tMongoDBOutput_1.put("Year","");
                pathMap_tMongoDBOutput_1.put("Unit","");
                pathMap_tMongoDBOutput_1.put("Value","");
                pathMap_tMongoDBOutput_1.put("Flag","");
                pathMap_tMongoDBOutput_1.put("Note","");
	...
	final String decryptedPassword_tMongoDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:VG8cSagLRK9LP5Tz2igZiUFJUMI1h5rZ7+6RNS02HZp+Le+CHq0R");

                        mongoCredential_tMongoDBOutput_1 = com.mongodb.MongoCredential.createScramSha1Credential("userjob", "admin", new String(decryptedPassword_tMongoDBOutput_1).toCharArray());
                mongoCredentialList_tMongoDBOutput_1.add(mongoCredential_tMongoDBOutput_1);
                com.mongodb.ServerAddress serverAddress_tMongoDBOutput_1 = new com.mongodb.ServerAddress("172.31.252.148", 27017);
            ...
            resourceMap.put("mongo_tMongoDBOutput_1", mongo_tMongoDBOutput_1);
                db_tMongoDBOutput_1 = mongo_tMongoDBOutput_1.getDatabase("stock");




        db_tMongoDBOutput_1.getCollection("bronze_stock").drop();
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection("bronze_stock");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"/home/Adriend671/dataset/SUA_Crops_Livestock_E_All_Data.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							row1.AreaCodeM49 = null;
					
							row1.Area = null;
					
							row1.ItemCode = null;
					
							row1.ItemCodeCPC = null;
					
							row1.Item = null;
					
							row1.ElementCode = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.AreaCode = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.AreaCodeM49 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ItemCode = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ItemCodeCPC = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ElementCode = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Element = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.YearCode = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Year = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Unit = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
try{
				updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());
                                        ...
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("AreaCode"),"AreaCode", row1.AreaCode);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("AreaCodeM49"),"AreaCodeM49", row1.AreaCodeM49);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Area"),"Area", row1.Area);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("ItemCode"),"ItemCode", row1.ItemCode);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("ItemCodeCPC"),"ItemCodeCPC", row1.ItemCodeCPC);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Item"),"Item", row1.Item);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("ElementCode"),"ElementCode", row1.ElementCode);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Element"),"Element", row1.Element);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("YearCode"),"YearCode", row1.YearCode);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Year"),"Year", row1.Year);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Unit"),"Unit", row1.Unit);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Value"),"Value", row1.Value);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Flag"),"Flag", row1.Flag);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Note"),"Note", row1.Note);
 ...
 */
    ...
    public static void main(String[] args){
        final BronzeJob_Stockage BronzeJob_StockageClass = new BronzeJob_Stockage();

        int exitCode = BronzeJob_StockageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BronzeJob_Stockage.class.getClassLoader().getResourceAsStream("goldproject/bronzejob_stockage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BronzeJob_Stockage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BronzeJob_Stockage");
        }
...
/************************************************************************************************
 *     62175 characters generated by Talend Open Studio for Big Data 
 *     on the 27 février 2026, 02:14:19 CET
 ************************************************************************************************/