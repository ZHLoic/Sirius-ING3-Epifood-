...
package goldproject.silverjob_stockage_0_1;
...
/**
 * Job: SilverJob_Stockage Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SilverJob_Stockage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SilverJob_Stockage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SilverJob_Stockage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SilverJob_Stockage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class silveroutStruct implements routines.system.IPersistableRow<silveroutStruct> {
    final static byte[] commonByteArrayLock_GOLDPROJECT_SilverJob_Stockage = new byte[0];
    static byte[] commonByteArray_GOLDPROJECT_SilverJob_Stockage = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GOLDPROJECT_SilverJob_Stockage.length) {
				if(length < 1024 && commonByteArray_GOLDPROJECT_SilverJob_Stockage.length == 0) {
   					commonByteArray_GOLDPROJECT_SilverJob_Stockage = new byte[1024];
				} else {
   					commonByteArray_GOLDPROJECT_SilverJob_Stockage = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GOLDPROJECT_SilverJob_Stockage, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_SilverJob_Stockage, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_GOLDPROJECT_SilverJob_Stockage, 0, length);
			strReturn = new String(commonByteArray_GOLDPROJECT_SilverJob_Stockage, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GOLDPROJECT_SilverJob_Stockage) {
...
final String applicationName_tMongoDBOutput_1 = "Talend";
	...
	final String decryptedPassword_tMongoDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:qhjjuUyt7aZXfyT8YaQmFGJJ8k8wdR8Z54ruxO4Ut5kTHqIf+xu4");
                        
	                        mongoCredential_tMongoDBOutput_1 = com.mongodb.MongoCredential.createScramSha256Credential("userjob", "stock", new String(decryptedPassword_tMongoDBOutput_1).toCharArray());
        ...
        db_tMongoDBOutput_1.getCollection("silver_stock").drop();
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection("silver_stock");
...
final String applicationName_tMongoDBInput_1 = "Talend";
	...
	final String decryptedPassword_tMongoDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:loIKXZJ2GeI1APdc1KmIg49YhOG1uvtbO3c8DzVW9kvjjjehVVl5");
        ...
        db_tMongoDBInput_1 = mongo_tMongoDBInput_1.getDatabase("stock");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_1 = db_tMongoDBInput_1.getCollection("bronze_stock");
				...
				pathMap_tMongoDBInput_1.put("AreaCode","");
				pathMap_tMongoDBInput_1.put("AreaCodeM49","");
				pathMap_tMongoDBInput_1.put("Area","");
				pathMap_tMongoDBInput_1.put("ItemCode","");
				pathMap_tMongoDBInput_1.put("ItemCodeCPC","");
				pathMap_tMongoDBInput_1.put("Item","");
				pathMap_tMongoDBInput_1.put("ElementCode","");
				pathMap_tMongoDBInput_1.put("Element","");
				pathMap_tMongoDBInput_1.put("YearCode","");
				pathMap_tMongoDBInput_1.put("Year","");
				pathMap_tMongoDBInput_1.put("Unit","");
				pathMap_tMongoDBInput_1.put("Value","");
				pathMap_tMongoDBInput_1.put("Flag","");
				pathMap_tMongoDBInput_1.put("Note","");
				...
				Object valueObj_tMongoDBInput_1=null;
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("AreaCode"),"AreaCode",o_tMongoDBInput_1);
					
				row1.AreaCode = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("AreaCodeM49"),"AreaCodeM49",o_tMongoDBInput_1);
					
				row1.AreaCodeM49 = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("Area"),"Area",o_tMongoDBInput_1);
					
				row1.Area = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				...
				row1.ItemCode = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("ItemCodeCPC"),"ItemCodeCPC",o_tMongoDBInput_1);
					
				row1.ItemCodeCPC = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				...
				row1.Item = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
                    ...
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("ElementCode"),"ElementCode",o_tMongoDBInput_1);
					
				row1.ElementCode = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				...
				row1.Element = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
                    ...
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("YearCode"),"YearCode",o_tMongoDBInput_1);
					
				row1.YearCode = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("Year"),"Year",o_tMongoDBInput_1);
					
				row1.Year = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("Unit"),"Unit",o_tMongoDBInput_1);
					
				row1.Unit = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				...
				row1.Value = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("Flag"),"Flag",o_tMongoDBInput_1);
					
				row1.Flag = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
				
                    valueObj_tMongoDBInput_1=dbObjectInputUtil_tMongoDBInput_1.getValue(pathMap_tMongoDBInput_1.get("Note"),"Note",o_tMongoDBInput_1);
					
				row1.Note = valueObj_tMongoDBInput_1==null ? null : valueObj_tMongoDBInput_1.toString();
...
silverout_tmp.ItemCode = Integer.parseInt(row1.ItemCode )
  ;
silverout_tmp.Item = row1.Item ;
silverout_tmp.Element = row1.Element ;
silverout_tmp.Value = Double.parseDouble(row1.Value);
...
try{
				updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());
                                        ...
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("ItemCode"),"ItemCode", silverout.ItemCode);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Item"),"Item", silverout.Item);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Element"),"Element", silverout.Element);
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("Value"),"Value", silverout.Value);
 ...
 */
    ...
    public static void main(String[] args){
        final SilverJob_Stockage SilverJob_StockageClass = new SilverJob_Stockage();

        int exitCode = SilverJob_StockageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SilverJob_Stockage.class.getClassLoader().getResourceAsStream("goldproject/silverjob_stockage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SilverJob_Stockage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SilverJob_Stockage");
        }
...
/************************************************************************************************
 *     69359 characters generated by Talend Open Studio for Big Data 
 *     on the 27 février 2026, 02:01:39 CET
 ************************************************************************************************/